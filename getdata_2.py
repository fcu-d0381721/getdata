...
import numpy as np
from dbconnect1 import connectDB
...
def main():
    ...
    # 處理小時
    EndTime = datetime.datetime.strptime('2358', "%H%M")
    ...
    for day in range(0, total_days):
        ...
        for minute in range(0, total_minutes):
            ...
            result = requests.get("http://tisvcloud.freeway.gov.tw/history/vd/" + end_date + "/vd_value_" + minute_time + ".xml.gz")
